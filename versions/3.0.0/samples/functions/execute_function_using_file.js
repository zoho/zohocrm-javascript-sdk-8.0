class ExecuteFunctionUsingFile {
    ...
    static async executeFunctionUsingFile() {
        ...
        let functionOperations = new ZCRM.Function.Operations(apiNameOfFunction, authType, null);
        let paramInstance = new ParameterMap();

        await paramInstance.add(new Param("JS", Object.prototype.toString.call(param)), param);
