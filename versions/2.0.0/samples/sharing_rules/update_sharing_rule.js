class UpdateSharingRule{
	static async call() {
		...
		(await new InitializeBuilder())
			...
			.token(token)
			.initialize();
		await UpdateSharingRule.updateSharingRule(BigInt("34771001"), "Leads");
    }
    ...
    static async updateSharingRule(id, moduleAPIName) {
        ...
        const sharedFromResource = new ZCRM.SharingRule.Model.Resource();
        sharedFromResource.setId(BigInt("34777236002"));
        ...
        const sharedToResource = new ZCRM.SharingRule.Model.Resource();
        sharedToResource.setId(BigInt("3477236002"));
