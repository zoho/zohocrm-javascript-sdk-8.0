class CreateSharingRules{
    ...
    static async createSharingRules(moduleAPIName) {
        ...
        const resourceFrom = new ZCRM.SharingRule.Model.Resource();
        resourceFrom.setId(BigInt("347736002"));
        ...
        const resourceTo = new ZCRM.SharingRule.Model.Resource();
        resourceTo.setId(BigInt("3477236002"));
