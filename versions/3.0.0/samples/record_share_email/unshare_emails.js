class UnshareEmails{
    static async call() {
        ...
        let id = BigInt("333213231");
		await UnshareEmails.unShareEmails(moduleAPIName, id);
	}

    static async unShareEmails(moduleAPIName, id) {
        const recordShareEmailOperations = new ZCRM.RecordShareEmail.RecordShareEmailOperations(moduleAPIName);
        ...
        if (response) {
            ...
            } else if (actionHandler instanceof ZCRM.RecordShareEmail.APIException) {
